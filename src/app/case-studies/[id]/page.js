...
const caseStudyData = {
  ...
  connectmax: {
    ...
    details: 'ConnectMax — это современный каталог, который позволяет пользователям мессенджера Max находить лучшие сообщества, AI-ботов, развлекательные и полезные каналы. Реализован удобный поиск, фильтрация по категориям, добавление своих проектов через модерацию. Проект разработан для масштабируемой нагрузки и быстрой работы.',
    process: [
      'Анализ целевой аудитории и конкурентов',
      'Проработка структуры каталога и UX/UI',
      'Разработка фронтенда и бэкенда',
      'Интеграция поиска и фильтрации',
      'Тестирование и оптимизация',
      'Запуск и поддержка проекта'
    ],
    result: 'Создан удобный и быстрый каталог, который помогает пользователям Max находить и продвигать лучшие сообщества и ботов. Проект получил положительные отзывы и активно развивается.',
    price: 'от 120 000 ₽',
    timeline: '2 месяца'
  },
  maxflow: {
    title: 'MaxFlow — рекламная сеть для Max',
    description: 'Демо-платформа, которая помогает компаниям быстро запускать рекламу и получать новых клиентов в мессенджере Max.',
    image: '/img/portfolio/maxflow.png',
    details: 'MaxFlow — это простой сервис для бизнеса, который хочет быстро и удобно запускать рекламу в новом мессенджере Max. Всё максимально понятно: выбираете, кому хотите показать рекламу, а система сама подбирает лучшие каналы и группы.',
    process: [
      'Обсудили с заказчиком, как должна работать платформа',
      'Сделали понятный и простой дизайн',
      'Реализовали личный кабинет для управления рекламой',
      'Настроили автоматический подбор каналов под нужную аудиторию',
      'Показали демо, внесли пожелания заказчика',
      'Запустили проект и обучили заказчика пользоваться сервисом'
    ],
    result: 'Получился сервис, которым легко пользоваться даже тем, кто не разбирается в рекламе и IT. Всё работает автоматически, экономит время и деньги.',
    price: 'от 180 000 ₽',
    timeline: '1,5 месяца'
  },
};
